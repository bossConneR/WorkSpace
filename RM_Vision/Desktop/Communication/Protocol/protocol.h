...
enum class Self_color: int { red=0B0101, blue=0B1010 };
...
struct Vision_send_data
{
    ...
    int cam_id;     // formatted in flag_register, low 8 bits
...
static Vision_recv_data decode(const std::string& s); // Decode data from std::string to Vision_recv_data
